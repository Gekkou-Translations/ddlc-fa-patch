init 1 python:
    # Fixes a bug that causes an exception when deleting monika.chr
    # while a dialog is being displayed. Ignored if the title has
    # been changed.
...
label ch30_main_override:
    ...
    $ stream_list = ["obs32.exe", "obs64.exe", "obs.exe"]
...
label ch30_postpoem_override:
    ...
    call showpoem (poem_m4, music=False) from _call_showpoem_22
    ...
    if list(set(process_list).intersection(stream_list)):
        call ch30_stream from _call_ch30_stream_1
